...
/**
 * The async counterpart of <code>SemtusServiceAsync</code>.
 */
public interface SemtusServiceAsync {
	
	void handleInput(String input, String level, AsyncCallback<String> callback)
			throws IllegalArgumentException;
	
	//void handleVisualize(String input, AsyncCallback<String> callback) throws IllegalArgumentException;
}
