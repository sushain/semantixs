 ...
 */
@RemoteServiceRelativePath("semtus")
public interface SemtusService extends RemoteService {
	
	String handleInput(String name, String level) throws IllegalArgumentException;

	// String handleVisualize(String input) throws IllegalArgumentException;
}
